...
passer_stats.columns = ['player_id', 'player_name', 'week', 'passing_yards', 'passing_td', 'interceptions', 'completions', 'attempts']
...
rusher_stats.columns = ['player_id', 'player_name', 'week', 'rushing_yards', 'rushing_td']
...
receiver_stats.columns = ['player_id', 'player_name', 'week', 'receiving_yards', 'receiving_td', 'receptions']
